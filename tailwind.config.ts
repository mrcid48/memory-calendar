  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        diary: {
          leather: "hsl(var(--diary-leather))",
          paper: "hsl(var(--diary-paper))",
          paperAged: "hsl(var(--diary-paper-aged))",
          ink: "hsl(var(--diary-ink))",
          gold: "hsl(var(--diary-gold))",
          spine: "hsl(var(--diary-spine))",
        },
        winter: {
        ...
        fall: {
          primary: "hsl(var(--fall-primary))",
          secondary: "hsl(var(--fall-secondary))",
          accent: "hsl(var(--fall-accent))",
        },
      },
      fontFamily: {
